                ...
                <div className='right-box text-sm'>
                    ...
                    <div className='mt-2 space-y-4 '>
                        ...
                        <p>
                            ...
                            proficient in PHP, Laravel, JavaScript, VueJs, and Reactjs. My main responsibilities are
                            building web applications, updating, maintaining, testing, and debugging applications.
                        </p>
                        <p>
